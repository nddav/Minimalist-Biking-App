 ...
 * 
 */
@WebServiceClient(name = "Service1", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:8090/MyService/Service1?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8090/MyService/Service1?wsdl");
     ...
     *     returns Interface1
     */
    @WebEndpoint(name = "BasicHttpBinding_Interface1")
    public Interface1 getBasicHttpBindingInterface1() {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_Interface1"), Interface1.class);
    }
     ...
     */
    @WebEndpoint(name = "BasicHttpBinding_Interface1")
    public Interface1 getBasicHttpBindingInterface1(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_Interface1"), Interface1.class, features);
    }
