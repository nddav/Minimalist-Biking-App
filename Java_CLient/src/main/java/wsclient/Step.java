...
@XmlType(name = "Step", namespace = "http://schemas.datacontract.org/2004/07/Lets_go_biking", propOrder = {
    "distance",
    "instruction"
})
public class Step {
    ...
    @XmlElementRef(name = "instruction", namespace = "http://schemas.datacontract.org/2004/07/Lets_go_biking", type = JAXBElement.class, required = false)
